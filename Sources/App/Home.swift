...
extension HtmlProvider {
    static func home() -> Node {
        ...
        let content = div([`class`("page-content")], [
            p([
                "Hi, it's Marco! I build iOS apps, contribute to open source and study Computer Engineering. I became an iOS Developer in 2016 studying at the Apple Developer Academy in Italy, then started working while starting my Computer Engineering program. I love basketball, books, TV series and tech. I like contributing to open source ", a([`class`("link"), openSource], ["(see here)"]), " and recently started contributing ", a([`class`("link"), writing],["to the italian version of NSHipster.com"]), ". You can find some of the apps I published on the App Store ",
            ...
            ul([
                li(["Email: ", a([`class`("link"), mail], ["Email"])]),
