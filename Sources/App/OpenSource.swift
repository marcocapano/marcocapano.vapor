...
extension HtmlProvider {
    static func openSource() -> Node {
        let projects: [Item] = [
            ...
            Item(title: "📩 MCChatModule", url: "https://github.com/marcocapano/MCChatModule", tag: "CREATOR", description: "A simple chat module to integrate with your app. This project is intended as an exercise for both the chat module and pod creation (dealing with podspec is harder than coding😂). If you want more features and a supportive community, I would suggest using MessageKit.")
        ]
